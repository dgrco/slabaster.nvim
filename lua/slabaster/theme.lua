...
function M.load(name, p)
  ...
  set({
    ...
    MatchParen    = { bg = p.matchparen or p.border, bold = true },
  ...
  set({
    ...
    Tag            = { fg = p.builtin },
    Delimiter      = { fg = p.delimiter or p.fg_dim },
  ...
  set({
    ...
    ["@keyword.import"]        = { fg = p.import or p.type },
    ...
    ["@field"]                 = { fg = p.fg },
    ["@parameter"]             = { fg = p.fg },
    ["@punctuation.delimiter"] = { fg = p.delimiter or p.fg_dim },
    ...
    ["@tag.delimiter"]         = { fg = p.delimiter or p.fg_dim },
    ["@text"]                  = { fg = p.fg },
