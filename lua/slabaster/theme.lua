...
function M.load(name, p)
  ...
  set({
    ...
    Statement      = { fg = p.keyword, bold = p.bold_keywords },
    Conditional    = { fg = p.keyword, bold = p.bold_keywords },
    Repeat         = { fg = p.keyword, bold = p.bold_keywords },
    Label          = { fg = p.keyword, bold = p.bold_keywords },
    Operator       = { fg = p.fg },
    Keyword        = { fg = p.keyword, bold = p.bold_keywords },
    Exception      = { fg = p.keyword, bold = p.bold_keywords },
